import { GenerateSubTypeInterface, WrapType, IFromQueryOptions, InputFormatter, IDefaultTypeMap, QueryNamer, EnumFormatter, InterfaceAndTypeBuilder, InterfaceDeclarationGenerator, TypeJoiner, TypePrinter, NamespaceGenerator, InterfaceNameWithExtensions, EnumTypeBuilder, GenerateDocumentation } from '@gql2ts/types';
...
export declare const interfaceExtendListToString: (extensions: string[]) => string;
